  ...
  return (
    <div className="font-mono text-sm">
        <div className="text-vscode-text-dim mb-4">
            ...
            &nbsp;* @module Blog <br/>
            &nbsp;* <br/>
            &nbsp;* Blog Index writen by: @wandriputra <br/>
            &nbsp;*/
        </div>
        
        <div className="text-vscode-keyword">export const <span className="text-vscode-func">posts</span> = [ </div>
        <div className="pl-4 mt-2">
            {blogs.map(blog => (
                <div key={blog.slug} className="mb-2">
                    {'{'} <br/>
                    &nbsp;&nbsp;<span className="text-vscode-keyword">slug</span>: <Link to={`/blog/${blog.slug}`} className="text-vscode-string text-blue-400 font-bold underline cursor-pointer">"{blog.slug}"</Link>, <br/>
